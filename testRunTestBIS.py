...
#==================================================#
		...
		Analysis.initialize(sizeROI, rInner, addToROI, debug)
		Analysis.outerRegionAnalysis(sizeROI, rInner, sqrtTsThreshold, minSeparation, debug)
		d, extRadius = Analysis.innerRegionAnalysis(sizeROI, rInner, maxIter, sqrtTsThreshold, minSeparation, debug)
		Analysis.overlapDisk(radius, extRadius, d)
